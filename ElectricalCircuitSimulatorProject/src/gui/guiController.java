...
//			alert("Circuit type choosing ALERT!","You have not choose a Circuit type yet");
	...
	@FXML
	void btnChatGPTOn(ActionEvent event) {
		try {
			final String STORE_FXML_FILE_PATH = "/gui/ChatGPT.fxml";
			FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource(STORE_FXML_FILE_PATH));
			fxmlLoader.setController(new GPTController());
			Parent root = fxmlLoader.load();
			EmbeddedWindow stage = (EmbeddedWindow) ((Node) event.getSource()).getScene().getWindow();
